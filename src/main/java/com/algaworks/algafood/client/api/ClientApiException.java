...
public class ClientApiException extends RuntimeException {
	...
	private void deserializeProblem(RestClientResponseException cause) {
		...
		// para nao falhar quando tem fields no json que nao tem correspondente na classe
		mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
		
		// para serializer ou desserializar tipos Time
		...
		try {
			...
			log.warn("Nao foi posivel desserializar a resposta em um problema", e);
		}
	}
